...
public class TimetableOCR {
    ...
    static String primaryBlockOCR(Tesseract tess, BufferedImage original,
        ...
        // 블록 crop → bicubic 2x 업스케일 → Tesseract
        try {
            int upW = w * 2, upH = h * 2;
            BufferedImage upscaled = new BufferedImage(upW, upH, BufferedImage.TYPE_INT_RGB);
            java.awt.Graphics2D g = upscaled.createGraphics();
            g.setRenderingHint(java.awt.RenderingHints.KEY_INTERPOLATION,
                    java.awt.RenderingHints.VALUE_INTERPOLATION_BICUBIC);
            g.setRenderingHint(java.awt.RenderingHints.KEY_RENDERING,
                    java.awt.RenderingHints.VALUE_RENDER_QUALITY);
            g.drawImage(original.getSubimage(x, y, w, h), 0, 0, upW, upH, null);
            g.dispose();
            return ocrBlock(tess, upscaled);
        } catch (Exception e) {
            return "";
        }
    }
